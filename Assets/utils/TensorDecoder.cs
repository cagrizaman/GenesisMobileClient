...
namespace TensorFlowServing.Utils
{
    class TensorProtoDecoder
    {
        ...
        public static float[] TensorProtoToFloatArray(TensorProto tensorProto, int arrayLen=0)
        {
            int receivedArrayLen = tensorProto.FloatVal.Count;
            if (arrayLen == 0)
            {
            ...
            tensorProto.FloatVal.CopyTo(floatArray, 0);
            return floatArray;
        }
